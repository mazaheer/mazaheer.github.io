...
<ul style="list-style-type:circle"> 
  ...
  <li> William Stein's <a href="https://wstein.org">webpage</a></li> (contains nice photos and LaTeX templates)
  <li> Kein Conrad <a href="https://kconrad.math.uconn.edu">webpage</a></li> (treasure of notes on almost everything)
  <li> Terry Tao's <a href= "https://terrytao.wordpress.com">blog</a><li> (can be depressing at time to fathom how much one can possibly achieve)
</ul>
